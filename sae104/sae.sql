--
-- Base de données du festival "transmusicale"
--


-- Initialisation de schéma
...
-- CREATE TABLE _concert(
--     no_concert char(20) PRIMARY KEY,
--     titre char(20) UNIQUE NOT NULL,
--     resume char(20) NOT NULL,
...
--     nom_groupe_artiste CHAR(30) NOT NULL UNIQUE,
--     site_web CHAR(30) NOT NULL,
-- );

-- CREATE TABLE _Edition(
--     nom_edition CHAR(20) PRIMARY KEY,
-- );

-- CREATE TABLE _Pays(
--     nom_p CHAR(20) PRIMARY KEY,
-- );
...
-- CREATE TABLE _ville(
--     nom_v char(20) PRIMARY KEY,
-- );

-- CREATE TABLE _type_musique(
--     type_m char(20) PRIMARY KEY,
-- );

-- CREATE TABLE _lieu(
--     id_lieu char(20) PRIMARY KEY,
--     nom_lieu char(20) NOT NULL UNIQUE,
--     accesPMR boolean NOT NULL,
--     capacite_max int NOT NULL CHECK (capacite_max > 0),
--     type_lieu char(20) NOT NULL,
-- );

-- CREATE TABLE _formation(
--     libelle_formation char(20) PRIMARY KEY,
-- );
